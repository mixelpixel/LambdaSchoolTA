...
if (students % 2 != 0) {
  console.log(`There's an odd number of students, we'll need to put ${students[students.length - 1]} in a triplet`);
  // TODO: randomly select a group to assign extra students[students.length -1]
}
